...
Project developed as part of the _Software Engineering_ course.
...
_Note: As this repository is featured in my portfolio, below are my specific core contributions to the project. For full technical details, see the [DobbySense README](./dobbySense/README.md)._

- **[DobbySense Recommendation Engine](./dobbySense/README.md)**: Designed, developed, and trained a custom Hybrid Matrix Factorization model using PyTorch to solve the "Cold Start" problem.
- **MLOps & Cloud Infrastructure**: Engineered a serverless, containerized training pipeline deployed on Google Cloud Platform (Vertex AI) using Docker.
- **Algorithmic Design**: Architected the "Fold-In" algorithm for real-time user embeddings and the FBS (Filter, Better-Similar) system for high-quality recommendation post-processing.
...
> This repository contains _Open Educational Resources (OER)_ and is licensed under the Creative Commons license, allowing you to use and share the material under the following terms:
